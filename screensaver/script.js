$(document).ready(function() { //always do this first. A special event 
  ...
  for (i = 0; i < 500; i++) { 
    $("h1").append( "<div class='element' style='transform: rotate(" + i*-1 + "deg);'></div>" );
    console.log("element " + i + " added");
  }

  for (i = 0; i < 500; i++) { 
$("h2").append( "<div class='element1' style='transform: rotate(" + i*1 + "deg);'></div>" );
    console.log("element " + i + " added");
  }
